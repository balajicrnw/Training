...
class ProductListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final authUser = ref.authUser;
    final isAuthLoading = !ref.isAuthInitialChecked;
        ...
        slivers: [
          ...
          SliverAppBar(
                      ...
                      Column(
                        ...
                        children: [
                          if (isAuthLoading)
                            ...
                            Text(
                              ref.userData?.name != null
                                  ? 'Hello, ${ref.userData!.name}'
                                  : 'Welcome back',
            ...
            actions: [
              ...
              /// ✅ FIXED CART BUTTON (Stack now tappable)
              Padding(
              ...
              if (!isAuthLoading)
                IconButton(
                  icon: Icon(
                    authUser != null ? Icons.logout : Icons.login,
                    color: Colors.white,
                  ),
                  onPressed: () {
                    if (authUser != null) {
