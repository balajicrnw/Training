...
class FirebaseFirestoreServiceImpl implements StorageService {
  ...
  Future<void> seedProducts() async {
    // Reusing the existing _seedProducts logic if it exists, or adding it here
    // For consistency with Appwrite, I'll just add the call to the existing one if available
    // but the internal one might have different data. Let's just implement it here.
    final productData = [
      {'title': 'Namma Filter Coffee', 'price': 299.0, 'category': 'Coffee'},
      {'title': 'Royal Silk Saree', 'price': 8500.0, 'category': 'Fashion'},
    ];
